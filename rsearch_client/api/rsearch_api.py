...
class RsearchApi(object):
    ...
    def get_advanced_doc_type_suggest_results(self, index_name, doc_type_name, suggest, **kwargs):  # noqa: E501
        ...
        Gets Suggestions from `doc_type_name` in `index_name` based on body params. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_advanced_multi_index_search_results(self, search, **kwargs):  # noqa: E501
        """get_advanced_multi_index_search_results  # noqa: E501

        Advanced Search across multiple indexes specified as a part of the search criteria. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_advanced_multi_index_search_results(search, async=True)
        >>> result = thread.get()

        :param async bool
        :param IndexesSearchQuery search: Details of the search query (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_advanced_multi_index_search_results_with_http_info(search, **kwargs)  # noqa: E501
        else:
            (data) = self.get_advanced_multi_index_search_results_with_http_info(search, **kwargs)  # noqa: E501
            return data

    def get_advanced_multi_index_search_results_with_http_info(self, search, **kwargs):  # noqa: E501
        """get_advanced_multi_index_search_results  # noqa: E501

        Advanced Search across multiple indexes specified as a part of the search criteria. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_advanced_multi_index_search_results_with_http_info(search, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_advanced_multi_index_search_results" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'search' is set
        if ('search' not in params or
                params['search'] is None):
            raise ValueError("Missing the required parameter `search` when calling `get_advanced_multi_index_search_results`")  # noqa: E501
    ...
    def get_advanced_multi_index_suggest_results(self, suggest, **kwargs):  # noqa: E501
        """get_advanced_multi_index_suggest_results  # noqa: E501

        Gets Suggestions across multiple indexes. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_advanced_multi_index_suggest_results(suggest, async=True)
        >>> result = thread.get()

        :param async bool
        :param IndexesSuggestQuery suggest: Details of the suggest query (required)
        :return: SuggestSuccess
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_advanced_multi_index_suggest_results_with_http_info(suggest, **kwargs)  # noqa: E501
        else:
            (data) = self.get_advanced_multi_index_suggest_results_with_http_info(suggest, **kwargs)  # noqa: E501
            return data

    def get_advanced_multi_index_suggest_results_with_http_info(self, suggest, **kwargs):  # noqa: E501
        """get_advanced_multi_index_suggest_results  # noqa: E501

        Gets Suggestions across multiple indexes. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_advanced_multi_index_suggest_results_with_http_info(suggest, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_advanced_multi_index_suggest_results" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'suggest' is set
        if ('suggest' not in params or
                params['suggest'] is None):
            raise ValueError("Missing the required parameter `suggest` when calling `get_advanced_multi_index_suggest_results`")  # noqa: E501
    ...
    def get_similar_docs_results(self, algorithm, **kwargs):  # noqa: E501
        """get_similar_docs_results  # noqa: E501

        Returns Similar Documents based on the provided document(s) details. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_similar_docs_results(algorithm, async=True)
        >>> result = thread.get()

        :param async bool
        :param AlgorithmSimilarDocsQuery algorithm: Query defintions (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_similar_docs_results_with_http_info(algorithm, **kwargs)  # noqa: E501
        else:
            (data) = self.get_similar_docs_results_with_http_info(algorithm, **kwargs)  # noqa: E501
            return data

    def get_similar_docs_results_with_http_info(self, algorithm, **kwargs):  # noqa: E501
        """get_similar_docs_results  # noqa: E501

        Returns Similar Documents based on the provided document(s) details. Please ensure you refer the getting started guides, to get the format of the query right.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_similar_docs_results_with_http_info(algorithm, async=True)
        >>> result = thread.get()
        ...
        all_params = ['algorithm']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_similar_docs_results" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('algorithm' not in params or
            ...
            raise ValueError("Missing the required parameter `algorithm` when calling `get_similar_docs_results`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/indexes/algorithms/similardocs', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AlgorithmSuccess',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
